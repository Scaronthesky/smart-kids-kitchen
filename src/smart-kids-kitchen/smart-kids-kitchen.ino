...
void loop() {
  ...
  if (currentOvenModeKnobState > 0 && currentMicrowaveKnobState == 0 && !tmrpcm.isPlaying()) {
    tmrpcm.play("1.wav", 1);
  } else if (currentOvenModeKnobState == 0 && currentMicrowaveKnobState > 0 && !tmrpcm.isPlaying()) {
    tmrpcm.play("2.wav", 1 );
  } else if (currentOvenModeKnobState > 0 && currentMicrowaveKnobState > 0 && !tmrpcm.isPlaying()) {
    tmrpcm.play("4.wav", 1);
  }
